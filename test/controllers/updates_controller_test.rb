...
class UpdatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create update" do
    assert_difference('Update.count') do
      post updates_url, params: { update: { comments: @update.comments, uname: @update.uname, updated_on: @update.updated_on } }
    end
  ...
  test "should update update" do
    patch update_url(@update), params: { update: { comments: @update.comments, uname: @update.uname, updated_on: @update.updated_on } }
