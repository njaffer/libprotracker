...
class CyclesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cycle" do
    assert_difference('Cycle.count') do
      post cycles_url, params: { cycle: { cycle_name: @cycle.cycle_name, duration: @cycle.duration } }
    end
  ...
  test "should update cycle" do
    patch cycle_url(@cycle), params: { cycle: { cycle_name: @cycle.cycle_name, duration: @cycle.duration } }
